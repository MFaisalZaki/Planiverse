...
- **Class:** `EnvNASim`
- **Import:** `from planiverse.environments.operational.network_attack.network_attack import EnvNASim`
- **Source:** [`network_attack.py`](../../planiverse/environments/operational/network_attack/network_attack.py)
...
| Path | What |
|---|---|
| [`network_attack.py`](../../planiverse/environments/operational/network_attack/network_attack.py) | The `perform_action` patch, `NASimState`, `EnvNASim`, `BENCHMARKS`, `GENERATED` |
