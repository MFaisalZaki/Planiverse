...
- **Class:** `SuperMarioEnv`
- **Import:** `from planiverse.environments.gameboy.super_mario_land import SuperMarioEnv, SuperMarioAction`
- **Source:** [`planiverse/environments/gameboy/super_mario_land.py`](../../planiverse/environments/gameboy/super_mario_land.py)
...
```python
import os
from planiverse.environments.gameboy.super_mario_land import SuperMarioEnv, SuperMarioAction
...
| Path | What |
|---|---|
| [`super_mario_bros_gb.py`](../../planiverse/environments/gameboy/super_mario_land.py) | `SuperMarioEnv`, `SuperMarioState`, `SuperMarioAction` |
