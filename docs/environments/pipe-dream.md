...
- **Import:** `from planiverse.environments.pipe_dream.environment import PipeDreamEnv`
- **Source:** [`planiverse/environments/pipe_dream/environment.py`](../../planiverse/environments/pipe_dream/environment.py)
...
```python
from planiverse.environments.pipe_dream.environment import PipeDreamEnv, PipeAction, DISCARD, FLUSH
...
| File | Contents |
|---|---|
| [`environment.py`](../../planiverse/environments/pipe_dream/environment.py) | `PipeAction`, `PipeState`, the flow (`advance`, `run_ahead`, `advances_due`), `draw_level`, `PipeDreamEnv` with `greedy_plan`, `LEVELS` |
