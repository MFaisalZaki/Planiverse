...
[sheet](../renders/power_grid_chart.png), the whole plan on one figure, with the action that produced
...
env.render_trace(trace, "power_grid_chart.png", actions=result.plan, env=env)     # contact sheet
```
