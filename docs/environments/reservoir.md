...
- **Import:** `from planiverse.environments.operational.reservoir.environment import ReservoirEnv`
- **Source:** [`planiverse/environments/operational/reservoir/environment.py`](../../planiverse/environments/operational/reservoir/environment.py)
...
| File | Contents |
|---|---|
| [`environment.py`](../../planiverse/environments/operational/reservoir/environment.py) | `ReservoirAction`, `ReservoirState`, `reference_plans`, `ReservoirEnv`, `YEARS` |
