...
- **Import:** `from planiverse.environments.operational.epidemic.environment import EpidemicEnv`
- **Source:** [`planiverse/environments/operational/epidemic/environment.py`](../../planiverse/environments/operational/epidemic/environment.py)
...
| File | Contents |
|---|---|
| [`environment.py`](../../planiverse/environments/operational/epidemic/environment.py) | `EpidemicAction`, `EpidemicState`, `replay`, `EpidemicEnv`, `OUTBREAKS` |
