...
network proxy blocks MDPI, the IIASA repository, arXiv and alexwg.org alike. This is built
instead from the abstract's description of the mechanism plus the causal-entropic-forces
formulation underneath it, and the split is stated rather than hidden:
