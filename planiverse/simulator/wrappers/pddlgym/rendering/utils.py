...
def render_from_layout(layout, get_token_images, dpi=150, grid_colors=None):
    ...
    # Vendored change: was `Image.ANTIALIAS`, removed in Pillow 10. This is the switch
    # pddlgym's own TODO here asked for, and it is why the upstream `pillow <10` pin --
    # which has no Python 3.13 wheels -- is not needed.
