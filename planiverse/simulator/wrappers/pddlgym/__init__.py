...
import matplotlib
# matplotlib.use("Agg")
from planiverse.simulator.wrappers.pddlgym.rendering import *
...
def register_pddl_env(name, is_test_env, other_args):
    ...
    register(
        ...
        entry_point='planiverse.simulator.wrappers.pddlgym.core:PDDLEnv',
...
for level in range(1, 8):
    register(
        ...
        entry_point=f'planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:SearchAndRescueEnv',
    ...
    register(
        ...
        entry_point=f'planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:PDDLSearchAndRescueEnv',
        kwargs={'level' : level, 'test' : False, 'render_version' : 'slow'},
    )
    register(
...
register(
    ...
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:SmallPOSARRadius1Env',
)

register(
    id='SmallPOSARRadius0-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:SmallPOSARRadius0Env',
)

register(
    id='POSARRadius1-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:POSARRadius1Env',
)

register(
    id='POSARRadius1Xray-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:POSARRadius1XrayEnv',
)

register(
    id='POSARRadius0-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:POSARRadius0Env',
)

register(
    id='POSARRadius0Xray-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:POSARRadius0XrayEnv',
)


register(
    id='SmallMyopicPOSAR-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:SmallMyopicPOSAREnv',
)

register(
    id='TinyMyopicPOSAR-v0',
    entry_point='planiverse.simulator.wrappers.pddlgym.custom.searchandrescue:TinyMyopicPOSAREnv',
)
