"""PDDL parsing.
"""
from planiverse.simulator.wrappers.pddlgym.structs import (Type, Predicate, Literal, LiteralConjunction,
...
def parse_plan_step(plan_step, operators, action_predicates, objects, operators_as_actions=False):
    ...
    # Vendored change: dropped `import ipdb; ipdb.set_trace()`, which masked this
    # raise with a ModuleNotFoundError.
