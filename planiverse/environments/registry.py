...
REGISTRY = (
    ...
    EnvironmentSpec(
        ...
        state_identity="path",
        requires=("covasim",),
        docs="docs/environments/epidemic.md",
        tags=frozenset({"operational", "health"}),
    ),
    EnvironmentSpec(
        name="traffic",
        ...
        deterministic=True,
        state_identity="path",
        requires=("libsumo", "sumo"),
        docs="docs/environments/traffic.md",
        tags=frozenset({"operational", "infrastructure", "traffic"}),
    ),
    EnvironmentSpec(
        name="airspace",
        ...
        state_identity="path",
        requires=("bluesky",),
        docs="docs/environments/airspace.md",
        tags=frozenset({"operational", "aviation"}),
    ),
    EnvironmentSpec(
        name="reservoir",
        ...
        state_identity="value",
        requires=("pywr",),
        docs="docs/environments/reservoir.md",
        tags=frozenset({"operational", "infrastructure", "water"}),
    ),
    EnvironmentSpec(
        name="factory",
