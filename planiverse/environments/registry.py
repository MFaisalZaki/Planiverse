...
REGISTRY = (
    EnvironmentSpec(
        ...
        instances="152 levels: the cartridge's 128, then 24 generated",
    ...
    EnvironmentSpec(
        ...
        instances="48 stages: 32 to the cartridge's table, then 16 generated",
    ...
    EnvironmentSpec(
        ...
        instances="121 rooms: the cartridge's 105, then 16 generated",
    ...
    EnvironmentSpec(
        ...
        instances="183 rooms: the cartridge's 163, then 20 generated",
    ...
    EnvironmentSpec(
        ...
        factory="planiverse.environments.games.super_mario_land:SuperMarioLandGame",
        summary="Super Mario Land-style platformer with approximated physics, in pure Python",
        instances="24 levels: the ramp of 12, then 12 generated",
    ...
    EnvironmentSpec(
        ...
        instances="24 networks: NASim's 18 benchmarks, then 6 generated",
    ...
    EnvironmentSpec(
        ...
        instances="15 scenarios: 9 chosen, then 6 generated",
    ...
    EnvironmentSpec(
        ...
        instances="15 contingencies: 9 chosen, then 6 generated",
    ...
    EnvironmentSpec(
        ...
        instances="30 seasons: 22 years, then 8 with the sowing moved",
