...
Scenario = namedtuple("Scenario", ["network", "source", "baseline", "solved_at", "seed"],
                      defaults=(None,))
...
SCENARIOS = (
    ...
    Scenario("Net1.inp", "13", 0.123, 2, seed=6006),
    Scenario("Net3.inp", "199", 0.414, 2, seed=6007),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6008),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6009),
    Scenario("Net3.inp", "199", 0.414, 2, seed=6010),
    Scenario("Net3.inp", "10", 0.171, 1, seed=6011),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6012),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6013),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6014),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6015),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6016),
    Scenario("Net3.inp", "161", 0.56, 2, seed=6017),
    Scenario("Net3.inp", "169", 0.565, 2, seed=6018),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6019),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6020),
    Scenario("Net3.inp", "157", 0.527, 1, seed=6021),
    Scenario("Net3.inp", "61", 0.488, 1, seed=6022),
    Scenario("Net3.inp", "199", 0.414, 2, seed=6023),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6024),
    Scenario("Net3.inp", "35", 0.163, 1, seed=6025),
    Scenario("Net3.inp", "61", 0.488, 1, seed=6026),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6027),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6028),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6029),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6030),
    Scenario("Net3.inp", "101", 0.189, 2, seed=6031),
    Scenario("Net3.inp", "121", 0.563, 2, seed=6032),
    Scenario("Net3.inp", "159", 0.551, 1, seed=6033),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6034),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6035),
    Scenario("Net3.inp", "173", 0.413, 1, seed=6036),
    Scenario("Net3.inp", "35", 0.163, 1, seed=6037),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6038),
    Scenario("Net3.inp", "35", 0.163, 1, seed=6039),
    Scenario("Net3.inp", "265", 0.565, 2, seed=6040),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6041),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6042),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6043),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6044),
    Scenario("Net3.inp", "271", 0.147, 1, seed=6045),
    Scenario("Net3.inp", "169", 0.565, 2, seed=6046),
    Scenario("Net3.inp", "271", 0.147, 1, seed=6047),
    Scenario("Net3.inp", "10", 0.171, 1, seed=6048),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6049),
    Scenario("Net3.inp", "271", 0.147, 1, seed=6050),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6051),
    Scenario("Net3.inp", "199", 0.414, 2, seed=6052),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6053),
    Scenario("Net3.inp", "199", 0.414, 2, seed=6054),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6055),
    Scenario("Net3.inp", "601", 0.181, 1, seed=6056),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6057),
    Scenario("Net3.inp", "161", 0.56, 2, seed=6058),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6059),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6060),
    Scenario("Net3.inp", "169", 0.565, 2, seed=6061),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6062),
    Scenario("Net3.inp", "157", 0.527, 1, seed=6063),
    Scenario("Net3.inp", "163", 0.557, 1, seed=6064),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6065),
    Scenario("Net3.inp", "60", 0.488, 1, seed=6066),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6067),
    Scenario("Net1.inp", "12", 0.408, 4, seed=6068),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6069),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6070),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6071),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6072),
    Scenario("Net1.inp", "21", 0.3, 3, seed=6073),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6074),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6075),
    Scenario("Net3.inp", "601", 0.181, 1, seed=6076),
    Scenario("Net3.inp", "601", 0.181, 1, seed=6077),
    Scenario("Net3.inp", "121", 0.563, 2, seed=6078),
    Scenario("Net3.inp", "119", 0.562, 3, seed=6079),
    Scenario("Net3.inp", "101", 0.189, 2, seed=6080),
    Scenario("Net3.inp", "61", 0.488, 1, seed=6081),
    Scenario("Net1.inp", "31", 0.113, 2, seed=6082),
    Scenario("Net3.inp", "171", 0.548, 2, seed=6083),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6084),
    Scenario("Net3.inp", "60", 0.488, 1, seed=6085),
    Scenario("Net1.inp", "23", 0.136, 2, seed=6086),
    Scenario("Net3.inp", "169", 0.565, 2, seed=6087),
    Scenario("Net3.inp", "10", 0.171, 1, seed=6088),
    Scenario("Net1.inp", "13", 0.123, 2, seed=6089),
    Scenario("Net3.inp", "161", 0.56, 2, seed=6090),
)
